...
//---------------------FINALISE---------------------------------------------------//
  ...
  rate_bruno->Fill( XeT1.TimeSec, cut_flow->GetBinContent(2) / livetime);
  rate_bruno->SetBinError(rate_bruno->FindBin( XeT1.TimeSec), cut_flow->GetBinError(2) /livetime);

  rate_48kg->Fill( XeT1.TimeSec, cut_flow->GetBinContent(3) / livetime);
  rate_48kg->SetBinError(rate_48kg->FindBin( XeT1.TimeSec), cut_flow->GetBinError(3) /livetime);

  rate_SR->Fill( XeT1.TimeSec, cut_flow->GetBinContent(4) / livetime);
  rate_SR->SetBinError(rate_SR->FindBin( XeT1.TimeSec), cut_flow->GetBinError(4) /livetime);
  ...
  event_time_bruno->Write("event_time_bruno_"+type);
  event_time_48kg->Write("event_time_48kg_"+type);
  event_time_SR->Write("event_time_SR_"+type);
  ...
  rate_2d->Write("rate_2d_"+dataset_name+"_"+type);
