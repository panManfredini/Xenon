...
#ifndef XenonDataReaderT1_h
#define XenonDataReaderT1_h
...
public :
   ...
   XenonDataReaderT1(TTree *tree=0);
   virtual ~XenonDataReaderT1();
...
#ifdef XenonDataReaderT1_cxx
XenonDataReaderT1::XenonDataReaderT1(TTree *tree) : fChain(0) 
{
...
XenonDataReaderT1::~XenonDataReaderT1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t XenonDataReaderT1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t XenonDataReaderT1::LoadTree(Long64_t entry)
{
...
void XenonDataReaderT1::Init(TTree *tree)
{
...
Bool_t XenonDataReaderT1::Notify()
{
...
void XenonDataReaderT1::Show(Long64_t entry)
{
...
Int_t XenonDataReaderT1::Cut(Long64_t entry)
{
...
#endif // #ifdef XenonDataReaderT1_cxx
